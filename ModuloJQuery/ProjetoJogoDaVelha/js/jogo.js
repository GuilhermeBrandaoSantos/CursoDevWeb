...
$(document).ready(function(){
	...
	$('#iniciaJogo').click(function() {

		// Valida o preenchimento dos apelidos
		if ($('#jogador_1').val() == '') {
		...
		// Exibe palco do jogo
		$('#palco_jogo').show('3000');		

		// Exibindo os Apelidos dos Jogadores
		$('#apelido_jogador_1').html($('#jogador_1').val());
		$('#apelido_jogador_2').html($('#jogador_2').val());

		$('#pagina_inicial').hide('1000');
